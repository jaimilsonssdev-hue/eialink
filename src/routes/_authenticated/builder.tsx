...
function BuilderPage() {
  ...
  const initialBio = bio
    ? {
        ...
        whatsapp: bio.whatsapp ?? profile?.whatsapp ?? "",
        whatsapp_message: bio.whatsapp_message ?? "Olá! Gostaria de saber mais.",
        ...
        pix_key: bio.pix_key ?? "",
        instagram: bio.instagram ?? profile?.instagram ?? "",
        published: bio.published,
        theme: bio.theme,
        cover_url: bio.cover_url,
        cover_position: bio.cover_position ?? "center",
        cover_fit: bio.cover_fit ?? "cover",
        cover_overlay: bio.cover_overlay ?? true,
        cover_overlay_opacity: bio.cover_overlay_opacity ?? 45,
    ...
    : {
        ...
        whatsapp_message: "Olá! Gostaria de saber mais.",
        pix_key: "",
  ...
  return (
    <UnifiedPageEditor
      ...
      initialCopilotOpen={Boolean(requestedCopilot)}
