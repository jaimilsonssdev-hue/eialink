...
export const NICHE_MODELS: NicheModelConfig[] = [
  {
    ...
    title: "Odontologia & Estética Dental",
  ...
  },
  {
    ...
    templateId: "beauty-glow",
    nicheKey: "salao",
    nicheCategory: "Salão de Beleza",
    title: "Salão de Beleza & Studio Capilar",
    subtitle: "Mechas, corte, visagismo e catálogo de serviços",
    theme: "sunset",
    icon: Scissors,
    isGold: true,
  },
  ...
  },
  {
    ...
    nicheCategory: "Contabilidade e Finanças",
