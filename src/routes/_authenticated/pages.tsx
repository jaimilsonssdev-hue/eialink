...
const NICHE_OPTIONS: NicheQuickOption[] = [
  ...
  },
  {
    ...
    description: "Clínicas de estética, skincare, spa e harmonização",
    icon: Sparkles,
    color: "text-pink-400",
  ...
  },
  {
    ...
    description: "Salões, mechas, cortes, escova e visagismo",
    icon: Scissors,
    color: "text-rose-400",
  ...
  },
  {
    key: "barbearia",
    name: "Barbearia",
    description: "Barbearias modernas, cortes, degradê e barba",
    icon: Scissors,
  ...
  },
  {
    key: "restaurante",
    name: "Gastronomia",
    description: "Restaurantes, pizzarias, bistrôs e delivery",
  ...
  },
  {
    key: "petshop",
    name: "Pet Shop & Vet",
    description: "Clínicas veterinárias, banho, tosa e pet care",
    icon: Dog,
  ...
  },
  {
    key: "oficina",
    name: "Oficina & Auto",
    description: "Mecânica, revisão preventiva, pneus e auto center",
    icon: Wrench,
    color: "text-red-400",
  ...
  },
  {
    key: "imobiliaria",
    name: "Imobiliária",
    description: "Corretores, imóveis de alto padrão e lançamentos",
    icon: Building2,
  ...
  },
  {
    key: "contabilidade",
    name: "Contabilidade",
    description: "Gestão fiscal, abertura de empresas e BPO financeiro",
    icon: Calculator,
  ...
  },
  {
    ...
    description: "Estúdios de tatuagem artística e body piercing",
    icon: PenTool,
  ...
  },
  {
    key: "otica",
    name: "Ótica & Visão",
    description: "Armações de grife, exames de vista e lentes",
    icon: Glasses,
    color: "text-sky-400",
  ...
  },
  {
    ...
    description: "Empresas, lojas, consultores e prestadores gerais",
    icon: ShoppingBag,
