...
export class LawLayout implements TemplateLayoutRenderer {
  ...
  render(_model: TemplateRenderModel, ctx: LayoutRenderContext): ReactNode {
    ...
    return <div className="niche-law">
      ...
      <section className="niche-law-cta"><div><span>ATENDIMENTO PERSONALIZADO</span><h2>Vamos conversar sobre o seu caso?</h2><p>Inicie um atendimento com discrição e receba a orientação adequada.</p></div>{whatsapp && <a href={`https://wa.me/${whatsapp}?text=${encodeURIComponent("Olá! Gostaria de iniciar um atendimento jurídico.")}`} target="_blank" rel="noreferrer"><MessageCircle size={18} aria-hidden /> Iniciar atendimento</a>}</section>
